...
var file_ping_proto_rawDesc = []byte{
	...
	0x22, 0x1b, 0x0a, 0x05, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0x29, 0x0a, 0x06, 0x50,
	0x69, 0x6e, 0x67, 0x65, 0x72, 0x12, 0x1f, 0x0a, 0x04, 0x50, 0x69, 0x6e, 0x67, 0x12, 0x09, 0x2e,
	0x70, 0x62, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x1a, 0x0a, 0x2e, 0x70, 0x62, 0x2e, 0x52, 0x65,
	0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x42, 0x08, 0x5a, 0x06, 0x67, 0x65, 0x6e, 0x2f, 0x70, 0x62,
...
var file_ping_proto_depIdxs = []int32{
	0, // 0: pb.Pinger.Ping:input_type -> pb.Param
	1, // 1: pb.Pinger.Ping:output_type -> pb.Result
...
type PingerClient interface {
	Ping(ctx context.Context, in *Param, opts ...grpc.CallOption) (*Result, error)
}
...
func (c *pingerClient) Ping(ctx context.Context, in *Param, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/pb.Pinger/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PingerServer interface {
	Ping(context.Context, *Param) (*Result, error)
}
...
func (*UnimplementedPingerServer) Ping(context.Context, *Param) (*Result, error) {
...
func _Pinger_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Pinger/Ping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingerServer).Ping(ctx, req.(*Param))
	}
